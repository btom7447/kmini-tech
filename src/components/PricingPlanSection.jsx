...
export default function PricingPlanSection() {
    return (
        <section className="py-20 px-5 lg:px-20 xl:px-30 bg-black text-white overflow-hidden relative">
            {/* Background image */}
            <div
            ...
            <div className="mb-20 grid grid-col-1 lg:grid-cols-2 items-center gap-10">
                ...
                <p
                    className="mt-5 text-lg lg:text-2xl text-gray-300"
                    data-aos="fade-down"
                    data-aos-delay="400"
                >
            ...
            <div className="mt-20 w-full">
                <h3 className="text-4xl font-bold mb-10 text-center">Add-On Services</h3>
