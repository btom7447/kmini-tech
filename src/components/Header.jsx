...
export default function Header() {
  ...
  const navItem = (href, label) => {
    ...
    return (
      <li
        className={`relative group text-2xl font-extralight transition-colors ${
      ...
      >
        ...
        {/* Animated underline */}
        <span
          className={`absolute left-0 -bottom-1 h-[1px] bg-gold transition-all duration-500 ${
  ...
  const navLinks = (
    <ul className="hidden xl:flex space-x-10 items-center">
      ...
      <li className="relative group">
        <button
          className={`flex items-center gap-1 text-2xl font-extralight transition-colors ${
            pathname.startsWith("/solutions") ? "text-gold" : "hover:text-gold"
          }`}
            ...
            >
              <li
                className={`p-5 text-xl ${
                  pathname === "/solutions/data-analysis"
                    ? "text-gold"
                    : "hover:text-gold"
                }`}
              >
              ...
              <li
                className={`p-5 text-xl ${
                  pathname === "/solutions/digital-marketing"
                    ? "text-gold"
                    : "hover:text-gold"
                }`}
              >
              ...
              <li
                className={`p-5 text-xl ${
                  pathname === "/solutions/web-development"
                    ? "text-gold"
                    : "hover:text-gold"
                }`}
              >
